...
(library Library_1
	...
	(compDef "TPS563200DDCR" (originalName "TPS563200DDCR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "VFB") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(attr "Arrow Part Number" "TPS563200DDCR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tps563200ddcr/texas-instruments.html?utm_currency=USD&region=europe")
		(attr "Description" "17 V Input, 3A Synchronous Step-Down Regulator in SOT-23 with Advanced Eco-mode")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/TPS563200")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TPS563200DDCR.stp")
